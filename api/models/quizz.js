...
{
  id: 75,
question: 'Quel est le nom de la mission de la NASA qui a envoyé des astronautes sur la Lune pour la première fois en 1969?',
categorie: 'Astronomie',
answers: [
{
text: 'Apollo 11',
...
},
{
  ...
  answers: [
  {
  text: 'Un nombre premier est divisible par 1 et lui-même, tandis qu´un nombre composé a d´autres diviseurs en plus de 1 et lui-même.',
  isCorrect: true,
  },
  {
  ...
  {
  text: 'Un nombre premier est toujours pair, tandis qu´un nombre composé est toujours impair.',
  isCorrect: false,
  },
  {
  text: 'Un nombre composé est divisible par 1 et lui-même, tandis qu´un nombre premier a d´autres diviseurs en plus de 1 et lui-même.',
  isCorrect: false,
  },
  ],
},
...
{
  id: 103,
  question: 'Quelle est la série de bandes dessinées belge créée par Morris, mettant en scène un/des cow-boy?',
  categorie: 'Littérature',
  answers: [
  {
  text: 'Asterix',
...
{
  id: 104,
question: 'Quel est le manga écrit et illustré par Akira Toriyama, racontant les aventures de Son Goku?',
categorie: 'Littérature',
answers: [
{
text: 'Naruto',
...
{
  id: 117,
  question: 'Quel réalisateur a remporté le prix du meilleur réalisateur aux Oscars pour "La La Land"?',
  categorie: 'Art',
  answers: [
  {
  text: 'Christopher Nolan',
